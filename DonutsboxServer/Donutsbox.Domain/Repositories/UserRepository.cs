...
public class UserRepository(DonutsboxDbContext context) : IEntityRepository<User, string>
{
    ...
    public async Task<User?> GetByIdAsync(string id) => await context.Users.FirstOrDefaultAsync(u => u.GUID == id);
